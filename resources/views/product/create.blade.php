                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('product.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="name" class="block w-full border-gray-300 dark:border-amber-500/30 dark:bg-[#252525] dark:text-white focus:border-amber-500 focus:ring-amber-500 rounded-md shadow-sm px-4 py-2" type="text" name="name" value="{{ old('name') }}" autofocus autocomplete="name" />
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <input id="qty" class="block w-full border-gray-300 dark:border-amber-500/30 dark:bg-[#252525] dark:text-white focus:border-amber-500 focus:ring-amber-500 rounded-md shadow-sm px-4 py-2" type="number" name="qty" value="{{ old('qty') }}" />
                            @error('qty')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input id="price" class="block w-full border-gray-300 dark:border-amber-500/30 dark:bg-[#252525] dark:text-white focus:border-amber-500 focus:ring-amber-500 rounded-md shadow-sm px-4 py-2" type="number" name="price" value="{{ old('price') }}" />
                            @error('price')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
