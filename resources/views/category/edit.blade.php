    ...
    <div class="py-12 bg-gray-50 dark:bg-gray-900 min-h-screen">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-4">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Update category details</p>
            </div>
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('category.update', $category->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="name" class="block w-full border-gray-300 dark:border-gray-700 dark:bg-[#252525] dark:text-white focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm px-4 py-2" type="text" name="name" value="{{ old('name', $category->name) }}" autofocus autocomplete="name" />
                            @error('name')
